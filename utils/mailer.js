...
/**
 * Getting and storing new token after prompting for user authorization, and then
...
/**
 * Creating an OAuth2 client with the given credentials, and then execute the
...
/**
 * Containing routines for mail delivery with GMail.
 */
